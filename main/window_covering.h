...
static inline
const char * window_covering_cmd_names(const ezb_zcl_window_covering_server_cmd_id_t cmd_id){
	switch(cmd_id){
		case EZB_ZCL_CMD_WINDOW_COVERING_UP_OPEN_ID: { return "EZB_ZCL_CMD_WINDOW_COVERING_UP_OPEN_ID"; } break;
		case EZB_ZCL_CMD_WINDOW_COVERING_DOWN_CLOSE_ID: { return "EZB_ZCL_CMD_WINDOW_COVERING_DOWN_CLOSE_ID"; } break;
		case EZB_ZCL_CMD_WINDOW_COVERING_STOP_ID: { return "EZB_ZCL_CMD_WINDOW_COVERING_STOP_ID"; } break;
		case EZB_ZCL_CMD_WINDOW_COVERING_GO_TO_LIFT_VALUE_ID: { return "EZB_ZCL_CMD_WINDOW_COVERING_GO_TO_LIFT_VALUE_ID"; } break;
		case EZB_ZCL_CMD_WINDOW_COVERING_GO_TO_LIFT_PERCENTAGE_ID: { return "EZB_ZCL_CMD_WINDOW_COVERING_GO_TO_LIFT_PERCENTAGE_ID"; } break;
		case EZB_ZCL_CMD_WINDOW_COVERING_GO_TO_TILT_VALUE_ID: { return "EZB_ZCL_CMD_WINDOW_COVERING_GO_TO_TILT_VALUE_ID"; } break;
		case EZB_ZCL_CMD_WINDOW_COVERING_GO_TO_TILT_PERCENTAGE_ID: { return "EZB_ZCL_CMD_WINDOW_COVERING_GO_TO_TILT_PERCENTAGE_ID"; } break;
	}
	return "unknown";
}
